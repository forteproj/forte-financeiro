...
const PLANO_SEED = [
  ...
  { id:'2.2.001', grupo:'2', desc:'ISS a Recolher (próprio)',                            cc:'CC-ADM-01',  tipo:'despesa', ex:'ISS sobre serviços sem retenção na fonte',                      ativa:true },
  { id:'2.2.002', grupo:'2', desc:'Tributos Federais a Recolher (próprio)',              cc:'CC-ADM-01',  tipo:'despesa', ex:'DARF IRPJ/CSLL/PIS/COFINS próprios',                           ativa:true },
  // 3.x CUSTOS DIRETOS
  ...
  { id:'3.2.900', grupo:'3', desc:'Folha Operacional Bruta',                            cc:'CC-ADM-02',  tipo:'despesa', ex:'Salários CLT das equipes de campo',                             ativa:true },
  { id:'3.2.901', grupo:'3', desc:'Encargos Operacionais — INSS / FGTS / RAT',         cc:'CC-ADM-02',  tipo:'despesa', ex:'INSS/FGTS patronal das equipes',                               ativa:true },
  { id:'3.2.902', grupo:'3', desc:'Benefícios Operacionais — VA / VT',                 cc:'CC-ADM-02',  tipo:'despesa', ex:'Vale transporte e alimentação equipes',                        ativa:true },
  { id:'3.2.903', grupo:'3', desc:'Horas Extras / Adicionais Operacionais',             cc:'CC-ADM-02',  tipo:'despesa', ex:'Horas extras das equipes de campo',                            ativa:true },
  ...
  // 4.x ADM
  { id:'4.1.001', grupo:'4', desc:'Pró-labore / Salários Pessoal Escritório',           cc:'CC-ADM-01',  tipo:'despesa', ex:'Pró-labore dos sócios + escritório',                           ativa:true },
  { id:'4.1.002', grupo:'4', desc:'Encargos ADM (INSS / FGTS / RAT)',                  cc:'CC-ADM-01',  tipo:'despesa', ex:'Encargos sobre folha administrativa',                          ativa:true },
  { id:'4.1.003', grupo:'4', desc:'Benefícios ADM (VA / VT)',                          cc:'CC-ADM-01',  tipo:'despesa', ex:'VA/VT do pessoal de escritório',                              ativa:true },
  { id:'4.2.001', grupo:'4', desc:'Aluguel / Condomínio — Escritório Central',         cc:'CC-ADM-01',  tipo:'despesa', ex:'Aluguel sede',                                                  ativa:true },
  { id:'4.2.002', grupo:'4', desc:'Energia / Água — Escritório Central',               cc:'CC-ADM-01',  tipo:'despesa', ex:'Contas da sede',                                               ativa:true },
  { id:'4.2.003', grupo:'4', desc:'Internet / Telefonia',                               cc:'CC-ADM-01',  tipo:'despesa', ex:'Internet e telefonia da sede',                                ativa:true },
  { id:'4.2.004', grupo:'4', desc:'Softwares / Sistemas / Licenças',                   cc:'CC-ADM-01',  tipo:'despesa', ex:'Conta Azul, licenças de software',                            ativa:true },
  { id:'4.2.005', grupo:'4', desc:'Seguro de Frota / Equipamentos',                    cc:'CC-ADM-01',  tipo:'despesa', ex:'Seguro anual da frota — corporativo',                         ativa:true },
  { id:'4.3.001', grupo:'4', desc:'Contabilidade',                                     cc:'CC-ADM-01',  tipo:'despesa', ex:'Honorários contábeis mensais',                                 ativa:true },
  { id:'4.3.002', grupo:'4', desc:'Jurídico',                                           cc:'CC-ADM-01',  tipo:'despesa', ex:'Assessoria jurídica',                                          ativa:true },
  { id:'4.4.001', grupo:'4', desc:'Certidões / Taxas de Licitação',                    cc:'CC-ADM-01',  tipo:'despesa', ex:'Certidão / taxa para licitação',                              ativa:true },
  { id:'4.4.002', grupo:'4', desc:'Viagens / Visitas Técnicas (Comercial)',             cc:'CC-ADM-01',  tipo:'despesa', ex:'Viagem comercial para visita técnica',                        ativa:true },
  { id:'4.5.001', grupo:'4', desc:'Material de Escritório',                             cc:'CC-ADM-01',  tipo:'despesa', ex:'Papelaria e material de escritório',                          ativa:true },
  // 5.x FINANCEIRO
  { id:'5.1.001', grupo:'5', desc:'Tarifas Bancárias',                                  cc:'CC-ADM-01',  tipo:'despesa', ex:'Tarifas bancárias do mês',                                    ativa:true },
  { id:'5.1.002', grupo:'5', desc:'Juros / Encargos Financeiros',                       cc:'CC-ADM-01',  tipo:'despesa', ex:'Juros sobre financiamento',                                   ativa:true },
  { id:'5.2.001', grupo:'5', desc:'Receitas Financeiras',                               cc:'CC-ADM-01',  tipo:'receita', ex:'Rendimento de aplicação financeira',                          ativa:true },
  // 6.x CAPEX
  { id:'6.1.001', grupo:'6', desc:'Investimentos / Imobilizado — CAPEX (acima R$ 2.500)', cc:'CC-ADM-03', tipo:'despesa', ex:'Compra de máquina Hotspray ou veículo',                     ativa:true },
];
